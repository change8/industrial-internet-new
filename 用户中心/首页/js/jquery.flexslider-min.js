...
(function (e) {
    e.flexslider = function (t, n) {
        ...
        v = {init: function () {
            ...
            var t = e('<div class="' + i + 'direction-nav"><a class="' + i + 'prev" href="#">' + r.vars.prevText + '</a><a class="' + i + 'next" href="#">' + r.vars.nextText + "</a></div>");
            if (r.controlsContainer) {
                e(r.controlsContainer).append(t);
                r.directionNav = e("." + i + "direction-nav a", r.controlsContainer)
            } else {
                r.append(t);
                r.directionNav = e("." + i + "direction-nav a", r)
            }
